...
var LogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/ktl/api/v1/agent.proto",
}
...
const (
	CaptureService_RunCapture_FullMethodName = "/ktl.api.v1.CaptureService/RunCapture"
)
...
type CaptureServiceClient interface {
	RunCapture(ctx context.Context, in *CaptureRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CaptureChunk], error)
}
...
func (c *captureServiceClient) RunCapture(ctx context.Context, in *CaptureRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CaptureChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CaptureService_ServiceDesc.Streams[0], CaptureService_RunCapture_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[CaptureRequest, CaptureChunk]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CaptureService_RunCaptureClient = grpc.ServerStreamingClient[CaptureChunk]
...
type CaptureServiceServer interface {
	RunCapture(*CaptureRequest, grpc.ServerStreamingServer[CaptureChunk]) error
...
func (UnimplementedCaptureServiceServer) RunCapture(*CaptureRequest, grpc.ServerStreamingServer[CaptureChunk]) error {
	return status.Error(codes.Unimplemented, "method RunCapture not implemented")
}
...
func _CaptureService_RunCapture_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CaptureRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CaptureServiceServer).RunCapture(m, &grpc.GenericServerStream[CaptureRequest, CaptureChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CaptureService_RunCaptureServer = grpc.ServerStreamingServer[CaptureChunk]
...
var CaptureService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ktl.api.v1.CaptureService",
	HandlerType: (*CaptureServiceServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "RunCapture",
			Handler:       _CaptureService_RunCapture_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "proto/ktl/api/v1/agent.proto",
...
const (
	DriftService_Watch_FullMethodName = "/ktl.api.v1.DriftService/Watch"
)
...
type DriftServiceClient interface {
	Watch(ctx context.Context, in *DriftWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DriftEvent], error)
}
...
func (c *driftServiceClient) Watch(ctx context.Context, in *DriftWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DriftEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DriftService_ServiceDesc.Streams[0], DriftService_Watch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DriftWatchRequest, DriftEvent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DriftService_WatchClient = grpc.ServerStreamingClient[DriftEvent]
...
type DriftServiceServer interface {
	Watch(*DriftWatchRequest, grpc.ServerStreamingServer[DriftEvent]) error
...
func (UnimplementedDriftServiceServer) Watch(*DriftWatchRequest, grpc.ServerStreamingServer[DriftEvent]) error {
...
func _DriftService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DriftWatchRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DriftServiceServer).Watch(m, &grpc.GenericServerStream[DriftWatchRequest, DriftEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DriftService_WatchServer = grpc.ServerStreamingServer[DriftEvent]

// DriftService_ServiceDesc is the grpc.ServiceDesc for DriftService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DriftService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ktl.api.v1.DriftService",
	HandlerType: (*DriftServiceServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Watch",
			Handler:       _DriftService_Watch_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "proto/ktl/api/v1/agent.proto",
