...
- Agent-backed NATS command execution, targeted fleet fan-out, capability
  reporting, worker-side capability enforcement, and identity receipts for stack
  nodes that need outbound worker fan-out without changing stack semantics.
