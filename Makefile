...
LDFLAGS ?= -s -w -X github.com/example/ktl/internal/buildinfo.Version=$(VERSION)
...
.PHONY: help build build-% install release gh-release tag-release push-release changelog test test-short test-integration fmt lint tidy verify docs clean loc print-%
