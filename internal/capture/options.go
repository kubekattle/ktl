...
func (o *Options) AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().BoolVar(&o.AttachManifests, "attach-manifests", o.AttachManifests, "Capture sanitized YAML manifests for observed pods + owner chain (may include sensitive env/config; review before sharing)")
}
