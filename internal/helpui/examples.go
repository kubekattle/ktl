...
var curatedExamples = map[string][]string{
	"torque": {
		...
		"# Start a NATS assignment worker with capability enforcement\ntorque-agent nats worker --nats-url nats://127.0.0.1:4222 --subject torque.lab.assign.mysql --queue mysql-workers --capability host.command.run",
