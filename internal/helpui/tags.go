...
var commandTags = map[string][]string{
	...
	"torque stack apply":              {"stack", "apply", "ops", "preflight", "replay", "host-command", "host-file", "host-package", "host-service", "host-user", "evidence"},
	"torque stack plan":               {"stack", "plan", "ops", "facts", "locks", "policy", "host-command", "host-file", "host-package", "host-service", "host-user"},
}
